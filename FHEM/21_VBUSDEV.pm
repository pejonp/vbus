...
my %VBUS_devices = (
 ...
 "4013" => {"name" => "WMZ3", "cmd" => "0100", "fields" => [
	...
	"4221" => {"name" => "DeltaSol_BS_Plus", "cmd" => "0100", "fields" => [
			...
			{ "offset" => 15, "name" => "Option:_Roehrenkollektor", "bitSize" => 1, "bitPos" => 3 },
			{ "offset" => 15, "name" => "Option:_Rueckkuehlung", "bitSize" => 1, "bitPos" => 4 },
			...
			{ "offset" => 20, "name" => "Waermemenge_1","bitSize" => 16,"factor" => 1,"unit" => "Wh" },
			{ "offset" => 22, "name" => "Waermemenge_2","bitSize" => 16,"factor" => 1000,"unit" => "Wh" },
			{ "offset" => 24, "name" => "Waermemenge_3","bitSize" => 16,"factor" => 1000000,"unit" => "Wh" },
...
"5210" => {"name" => "DeltaSolPlus", "cmd" => "0100", "fields" => [
	...
	"5420" => {"name" => "DeltaThermHC_WMZ0", "cmd" => "0100", "fields" => [ 	
			{ "offset" =>  0,"name" => "Wert","bitSize" => 31,"factor" => 1,"unit" => "Wh" },
			{ "offset" =>  4,"name" => "Leistung","bitSize" => 31,"unit" => "W" },
			{ "offset" =>  8,"name" => "WertHeute","bitSize" => 31,"factor" => 1,"unit" => "Wh" },
			{ "offset" =>  12,"name" => "WertWoche","bitSize" => 31,"factor" => 1,"unit" => "Wh" },
			]},
	"5421" => {"name" => "DeltaThermHC_WMZ1", "cmd" => "0100", "fields" => [ 	
			{ "offset" =>  0,"name" => "Wert","bitSize" => 31,"factor" => 1,"unit" => "Wh" },
			{ "offset" =>  4,"name" => "Leistung","bitSize" => 31,"unit" => "W" },
			{ "offset" =>  8,"name" => "WertHeute","bitSize" => 31,"factor" => 1,"unit" => "Wh" },
			{ "offset" =>  12,"name" => "WertWoche","bitSize" => 31,"factor" => 1,"unit" => "Wh" },
			]},
	"5430" => {"name" => "DeltaThermHC_MODUL0", "cmd" => "0100", "fields" => [ 
			{ "offset" => 0, "name" => "Sensor_1", "bitSize" => 15, "factor" => 1, "unit" => "°C" },
			{ "offset" => 2, "name" => "Sensor_2", "bitSize" => 15, "factor" => 1, "unit" => "°C" },
			{ "offset" => 4, "name" => "Sensor_3", "bitSize" => 15, "factor" => 1, "unit" => "°C" },
			{ "offset" => 6, "name" => "Sensor_4", "bitSize" => 15, "factor" => 1, "unit" => "°C" },
			{ "offset" => 8, "name" => "Sensor_5", "bitSize" => 15, "factor" => 1, "unit" => "°C" },	
			{ "offset" => 10, "name" => "Sensor_6", "bitSize" => 15, "factor" => 1, "unit" => "°C" },
			{ "offset" => 12, "name" => "Drehzahl_Relais_1", "bitSize" => 7, "factor" => 1, "unit" => "%" },
			{ "offset" => 13, "name" => "Drehzahl_Relais_2", "bitSize" => 7, "factor" => 1, "unit" => "%" },
			{ "offset" => 14, "name" => "Drehzahl_Relais_3", "bitSize" => 7, "factor" => 1, "unit" => "%" },
			{ "offset" => 15, "name" => "Drehzahl_Relais_4", "bitSize" => 7, "factor" => 1, "unit" => "%" },
			{ "offset" => 16, "name" => "Drehzahl_Relais_5", "bitSize" => 7, "factor" => 1, "unit" => "%" },
			]},
	"5431" => {"name" => "DeltaThermHC_MODUL1", "cmd" => "0100", "fields" => [ 
			{ "offset" => 0, "name" => "Sensor_1", "bitSize" => 15, "factor" => 1, "unit" => "°C" },
			{ "offset" => 2, "name" => "Sensor_2", "bitSize" => 15, "factor" => 1, "unit" => "°C" },
			{ "offset" => 4, "name" => "Sensor_3", "bitSize" => 15, "factor" => 1, "unit" => "°C" },
			{ "offset" => 6, "name" => "Sensor_4", "bitSize" => 15, "factor" => 1, "unit" => "°C" },
...
#	"7821" => {"name" => "MSR65_1", "cmd" => "0200", "fields" => [
	...
	"7112" => {"name" => "DeltaSol_BX_Plus_Regler", "cmd" => "0100", "fields" => [
			{ "offset" => 0, "name" => "Temperatur_Sensor_1", "bitSize" => 15, "factor" => 0.1, "unit" => "°C" },
			{ "offset" => 2, "name" => "Temperatur_Sensor_2", "bitSize" => 15, "factor" => 0.1, "unit" => "°C" },
			{ "offset" => 4, "name" => "Temperatur_Sensor_3", "bitSize" => 15, "factor" => 0.1, "unit" => "°C" },
			{ "offset" => 6, "name" => "Temperatur_Sensor_4", "bitSize" => 15, "factor" => 0.1, "unit" => "°C" },
			...
			{ "offset" => 14, "name" => "Temperatur_Sensor_8", "bitSize" => 15, "factor" => 0.1, "unit" => "°C" },
			{ "offset" => 16, "name" => "Temperatur_Sensor_9", "bitSize" => 15, "factor" => 0.1, "unit" => "°C" },
			{ "offset" => 18, "name" => "Einstrahlung_Sensor_10", "bitSize" => 15, "factor" => 1, "unit" => "W/qm" },
			{ "offset" => 20, "name" => "Temperatur_Sensor_11", "bitSize" => 15, "factor" => 0.1, "unit" => "°C" },
			{ "offset" => 22, "name" => "Temperatur_Sensor_12", "bitSize" => 15, "factor" => 0.1, "unit" => "°C" },
			{ "offset" => 24, "name" => "Volumenstrom_Sensor_9", "bitSize" => 31, "factor" => 1, "unit" => "l/h" },
			{ "offset" => 28, "name" => "Volumenstrom_Sensor_11", "bitSize" => 31, "factor" => 1, "unit" => "l/h" },
			{ "offset" => 32, "name" => "Volumenstrom_Sensor_12", "bitSize" => 31, "factor" => 1, "unit" => "l/h" },
			{ "offset" => 36,"name" => "Druck_Sensor_11","bitSize" => 15,"factor" => 0.01,"unit" => "bar" },
			{ "offset" => 38,"name" => "Druck_Sensor_12","bitSize" => 15,"factor" => 0.01,"unit" => "bar" },
			{ "offset" => 40, "name" => "Drehzahl_Relais_1", "bitSize" => 8, "factor" => 1, "unit" => "%" },
			{ "offset" => 41, "name" => "Drehzahl_Relais_2", "bitSize" => 8, "factor" => 1, "unit" => "%" },
			{ "offset" => 42, "name" => "Drehzahl_Relais_3", "bitSize" => 8, "factor" => 1, "unit" => "%" },
			{ "offset" => 43, "name" => "Drehzahl_Relais_4", "bitSize" => 8, "factor" => 1, "unit" => "%" },
			{ "offset" => 44, "name" => "Drehzahl_Relais_5", "bitSize" => 8, "factor" => 1, "unit" => "%" },
			{ "offset" => 48,"name" => "Systemdatum","bitSize" => 31},
			{ "offset" => 52, "name" => "Fehlermaske", "bitSize" => 31, "factor" => 1 },
			{ "offset" => 64, "name" => "PWM0-10VA", "bitSize" => 8, "factor" => 1, "unit" => "%" },
			{ "offset" => 65, "name" => "PWM0-10VB", "bitSize" => 8, "factor" => 1, "unit" => "%" },
			]},  
	"7113" => {"name" => "DeltaSol_BX_Plus_Module", "cmd" => "0100", "fields" => [
	...
	"7121" => {"name" => "DeltaSol_BX_Heizkreis", "cmd" => "0100", "fields" => [
...
#			{ "offset" => 14, "name" => "7160_Temperatur_Sensor_8", "bitSize" => 15, "factor" => 0.1, "unit" => "°C" },
			...
			{ "offset" => 24, "name" => "7160_Waerme", "bitSize" => 15, "factor" => 1, "unit" => "Wh" },
			{ "offset" => 26, "name" => "7160_Waerme", "bitSize" => 15, "factor" => 1000, "unit" => "Wh" },
			{ "offset" => 28, "name" => "7160_Waerme", "bitSize" => 15, "factor" => 1000000, "unit" => "Wh" },
			{ "offset" => 30, "name" => "7160_Waerme", "bitSize" => 15, "factor" => 1000000000, "unit" => "Wh" },
			{ "offset" => 60, "name" => "7160_Waerme_2", "bitSize" => 15, "factor" => 1, "unit" => "Wh" },
			{ "offset" => 62, "name" => "7160_Waerme_2", "bitSize" => 15, "factor" => 1000, "unit" => "Wh" },
			{ "offset" => 64, "name" => "7160_Waerme_2", "bitSize" => 15, "factor" => 1000000, "unit" => "Wh" },
			{ "offset" => 66, "name" => "7160_Waerme_2", "bitSize" => 15, "factor" => 1000000000, "unit" => "Wh" },
			{ "offset" => 68, "name" => "7160_Waerme_3", "bitSize" => 15, "factor" => 1, "unit" => "Wh" },
			{ "offset" => 70, "name" => "7160_Waerme_3", "bitSize" => 15, "factor" => 1000, "unit" => "Wh" },
			{ "offset" => 72, "name" => "7160_Waerme_3", "bitSize" => 15, "factor" => 1000000, "unit" => "Wh" },
			{ "offset" => 74, "name" => "7160_Waerme_3", "bitSize" => 15, "factor" => 1000000000, "unit" => "Wh" },
...
#			{ "offset" => 2,"name" => "Kollektor_Vorlauf","bitSize" => 15,"factor" => 0.1,"unit" => "°C" },
			{ "offset" => 4,"name" => "Volumenstrom_Kollektor","bitSize" => 15,"unit" => "l/h" },
			{ "offset" => 6,"name" => "Waermemenge_1","bitSize" => 16,"factor" => 1,"unit" => "Wh" },
			{ "offset" => 8,"name" => "Waermemenge_2","bitSize" => 16,"unit" => "kWh" },
			{ "offset" => 10,"name" => "Waermemenge_3","bitSize" => 16,"unit" => "MWh" },
			]},
...
#			{ "offset" => 92, "name" => "Systemdatum", "bitSize" => 31, },
	...
	"7342" => {"name" => "CitrinSLR_XT1", "cmd" => "0100", "fields" => [
			...
			{ "offset" => 8, "name" => "Temperatur_5", "bitSize" => 15, "factor" => 0.1, "unit" => "°C" },
			{ "offset" => 10, "name" => "Temperatur_6", "bitSize" => 15, "factor" => 0.1, "unit" => "°C" },
			{ "offset" => 12, "name" => "Drehzahl_1", "bitSize" => 8, "unit" => "%" },
			{ "offset" => 13, "name" => "Drehzahl_2", "bitSize" => 8, "unit" => "%" },
			{ "offset" => 14, "name" => "Drehzahl_3", "bitSize" => 8, "unit" => "%" },
			{ "offset" => 15, "name" => "Drehzahl_4", "bitSize" => 8, "unit" => "%" },
			{ "offset" => 16, "name" => "Drehzahl_5", "bitSize" => 8, "unit" => "%" },
			]},
	"7343" => {"name" => "CitrinSLR_XT2", "cmd" => "0100", "fields" => [
			{ "offset" => 0, "name" => "Temperatur_1", "bitSize" => 15, "factor" => 0.1, "unit" => "°C" },
			{ "offset" => 2, "name" => "Temperatur_2", "bitSize" => 15, "factor" => 0.1, "unit" => "°C" },
			{ "offset" => 4, "name" => "Temperatur_3", "bitSize" => 15, "factor" => 0.1, "unit" => "°C" },
			{ "offset" => 6, "name" => "Temperatur_4", "bitSize" => 15, "factor" => 0.1, "unit" => "°C" },
	...
	"7344" => {"name" => "CitrinSLR_XT3", "cmd" => "0100", "fields" => [
			{ "offset" => 0, "name" => "Temperatur_1", "bitSize" => 15, "factor" => 0.1, "unit" => "°C" },
			{ "offset" => 2, "name" => "Temperatur_2", "bitSize" => 15, "factor" => 0.1, "unit" => "°C" },
			{ "offset" => 4, "name" => "Temperatur_3", "bitSize" => 15, "factor" => 0.1, "unit" => "°C" },
			{ "offset" => 6, "name" => "Temperatur_4", "bitSize" => 15, "factor" => 0.1, "unit" => "°C" },
	...
	"7345" => {"name" => "CitrinSLR_XT4", "cmd" => "0100", "fields" => [
			{ "offset" => 0, "name" => "Temperatur_1", "bitSize" => 15, "factor" => 0.1, "unit" => "°C" },
			{ "offset" => 2, "name" => "Temperatur_2", "bitSize" => 15, "factor" => 0.1, "unit" => "°C" },
			{ "offset" => 4, "name" => "Temperatur_3", "bitSize" => 15, "factor" => 0.1, "unit" => "°C" },
			{ "offset" => 6, "name" => "Temperatur_4", "bitSize" => 15, "factor" => 0.1, "unit" => "°C" },
	...
	"7346" => {"name" => "CitrinSLR_XT5", "cmd" => "0100", "fields" => [
			{ "offset" => 0, "name" => "Temperatur_1", "bitSize" => 15, "factor" => 0.1, "unit" => "°C" },
			{ "offset" => 2, "name" => "Temperatur_2", "bitSize" => 15, "factor" => 0.1, "unit" => "°C" },
			{ "offset" => 4, "name" => "Temperatur_3", "bitSize" => 15, "factor" => 0.1, "unit" => "°C" },
			{ "offset" => 6, "name" => "Temperatur_4", "bitSize" => 15, "factor" => 0.1, "unit" => "°C" },
	...
	"7411" => {"name" => "DeltaSol_ES", "cmd" => "0100", "fields" => [
			...
			{ "offset" => 27, "name" => "Option:_Kollektorkuehlung", "bitSize" => 1, "bitPos" => 0 },
			...
			{ "offset" => 27, "name" => "Option:_Roehrenkollektorfunktion", "bitSize" => 1, "bitPos" => 3 },
			{ "offset" => 27, "name" => "Option:_Rueckkuehlung", "bitSize" => 1, "bitPos" => 4 },
			{ "offset" => 27, "name" => "Option:_Waermemengenzahlung", "bitSize" => 1, "bitPos" => 5 },
			...
			{ "offset" => 39, "name" => "Waermemenge_1","bitSize" => 16,"factor" => 1,"unit" => "Wh" },
			{ "offset" => 40, "name" => "Waermemenge_2","bitSize" => 16,"factor" => 1,"unit" => "Wh" },
			{ "offset" => 42, "name" => "Waermemenge_3","bitSize" => 16,"factor" => 1000,"unit" => "Wh" },
			{ "offset" => 44, "name" => "Waermemenge_4","bitSize" => 16,"factor" => 1000000,"unit" => "Wh" },
			]},
...
sub Initialize()
{
 ...
 # require "$attr{global}{modpath}/FHEM/19_VBUSIF.pm";
	my @modellist;
	for my $model (keys %VBUS_devices){
...
sub Parse()
{
  ...
  if( length($msg) >=20)
  {
   Log3 $iodev, 5, "Parse0a OK: ioName: ".$ioName. " count: " . $frameCount . " CRC: " . $headerCRC;;
  }
  else{
   Log3 $iodev, 5, "Parse0a NOK: ioName: ".$ioName. " count: " . $frameCount . " CRC: " . $headerCRC;;
      $cmd_ok = 0;
      return "";
  }
  
  Log3 $iodev, 4, "Parse00: ioName: ".$ioName. " DST-ADR: " . $dst_addr . " SRC-ADR: " . $src_addr;;
  
  if ($dst_addr == "0000")
  {
   	  Log3 $iodev, 4, "Parse01: Broadcast ioName: ".$ioName. " DST-ADR: " . $dst_addr;
      $cmd_ok = 0;
      return "";
  }
  ...
  if ($dst_addr == "0010")
  {
   		Log3 $iodev, 4, "Parse02: DFA       ioName: ".$ioName. " DST-ADR: " . $dst_addr;
      $cmd_ok = 1;
  }
   ...
   if ($dst_addr == "0015")
  {
      ...
      Log3 $iodev, 4, "Parse03: Standard-Infos ioName: ".$ioName. " DST-ADR: " . $dst_addr;
      $cmd_ok = 0;
      return "";
  }
   ...
   if ($dst_addr == "0020")
  {
   		Log3 $iodev, 4, "Parse04: Computer       ioName: ".$ioName. " DST-ADR: " . $dst_addr;
      $cmd_ok = 0;
		  return "";
  }
   ...
   if ($dst_addr == "0040")
  {
   		Log3 $iodev, 4, "Parse05: SD3 / GAx      ioName: ".$ioName. " DST-ADR: " . $dst_addr;
      $cmd_ok = 0;
		  return "";
  }
   ...
   if ($dst_addr == "0050")
  {
   		Log3 $iodev, 4, "Parse06: DL2      ioName: ".$ioName. " DST-ADR: " . $dst_addr;
      $cmd_ok = 0;
		  return "";
  }
     ...
     if ($dst_addr == "6521")
  {
  		Log3 $iodev, 4, "Parse07: MSR65    ioName: ".$ioName. " DST-ADR: " . $dst_addr;
      $cmd_ok = 1;
      $dst_addr = "0010";
      $src_addr = "6521";     
  }
  ...
  if ($cmd_ok == 0) {
	...
	if ( defined $devtype->{dst_addr} ) {
		if ( $devtype->{dst_addr} ne $dst_addr ) {
			 Log3 $iodev, 4, "Parse10: $ioName : skip frame $devtype->{dst_addr} $dst_addr";
			return "";
		}
	}
	...
	if(!$hash) {
		...
		Log3 $hash, 4, "Parse11: $ioName : $ret, please define it";
		DoTrigger("global", $ret);
		return "";
	}

   Log3 $iodev, 4, "Parse12: ".$ioName. " DST-ADR: " . $dst_addr . " SRC-ADR: " . $src_addr;


	for my $mod (keys %{$modules{VBUSDEV}{defptr}}) {
  	my $hash = $modules{VBUSDEV}{defptr}{"$src_addr"};
		$attr{$hash->{NAME}}{model} = $devtype->{name};
    my $command = substr($msg,14,2).substr($msg,12,2);
		my $payload = substr($msg,20);
    Log3 $iodev, 4, "Parse20 : Command " . $command . " DevTyp: ".$devtype." Model: ".$mod." MSG: " . $payload;
   	ParsePayload($hash, $devtype, $command, $payload);
		return $hash->{NAME};
	}
	return "";
}
...
sub ParsePayload()
{
  ...
  Log3 $hash, 4, "$name: ParsePayLoad1: Command: ".$cmd." Code " . $code . " DevTyp: ".$devname." Name: ".$name ;
  #return undef if ($cmd != $devtype->{cmd});
  return if ($cmd != $devtype->{cmd});
  Log3 $hash, 4, "$name: ParsePayload2: Dev: $devname CMD: $cmd  PayL: $payload";
	...
	for my $field (@{$devtype->{fields}}) {
		...
		if ($bitsize<=8) {
		 ...
		 Log3 $hash, 4, "$name: ParsePayload3: code: " . $code ." : " . $fieldname . " = " . $val;
      ...
      #Log3 $hash, 4, "$name: ParsePayload4: code: " . $code ." : " . $fieldname . " = " . $val ." ".$unit;
      Log3 $hash, 4, "$name: ParsePayload4: code: " . $code ." : " . $fieldname . " = " . $val2;
     	}
	}
  ...
  Log3 $hash, 4, "$name ParsePayload5: $name ($code) $devtype";  
  
    
        if(!$def) {
    		Log3 $hash, 4, '$name ParsePayload6: UNDEFINED Modul ' . $code;
      ...
      $hash = $def;
    	$name = $hash->{NAME};
      $code = $hash->{CODE};    	
    	Log3 $hash, 4, "$name ParsePayload7: $name ($code) $devtype)";  
